...
const famous_person = "Robin Waldo Emerson"
const message =  `"Do not go where the path may lead, go instead where there is no path and leave a trail."`
...
const name_1 = "\t Aqib Ayoub \n"

console.log(`Name with white space: ${name_1}`)

console.log(`Name after stripping the whitespace: ${name_1.trim()}`)
...
const message_1 = `My favorite number is: ${favoriteNumber}`
...
const names = ["Nawaz", "Abdul Jabbar", "Haris", "Muddassir", "Saad", "Taha"]
console.log(names[0])
console.log(names[1])
console.log(names[2])
console.log(names[3])
...
const message_2 = "Bhai kya haal hai?"

for (let index = 0; index < names.length; index++) {
  console.log(`Or ${names[index]} ${message_2}`) ; 
}
...
const myArray = ["Honda Kawasaki", "Rolce Royce Phantom 8", "Nissan GT-R", "Lamborghini", "Ferrarri"]
const message_3 = "I would like to own a"

for (let index = 0; index < myArray.length; index++) {
  console.log(`${message_3} ${myArray[index]}`) ; 
}